    ...
    <v-container fluid>
        ...
        <v-card tile class="mx-16 mt-n10 card1" color="white">
                    ...
                    <v-card height="250px" tile flat color="#3890D8">
                        <v-row>
                            <v-col cols="12" sm="4" class="pl-8 pt-5">
                                ...
                                <v-btn rounded color="#4C9CDB" dark class="withoutupercase px-8 mt-10"> More Info </v-btn>
                            </v-col>
                            <v-col cols="12" sm="8">
                                <v-img src="bike.png" max-height="400" max-width="400" contain></v-img>
                            </v-col>
                        </v-row>
                    </v-card>
                </v-col>
                    ...
                    <v-card height="250px" tile flat color="#6857E1">
                        <v-row>
                            <v-col cols="12" sm="6" class="pl-8 pt-5">
                                ...
                                <v-btn rounded color="#8375E7" dark class="withoutupercase px-8 mt-3"> More Info </v-btn>
                            </v-col>
                            <v-col cols="12" sm="6">
                                <v-img src="jacket2.png" max-height="400" max-width="420" contain></v-img>
                            </v-col>
                        </v-row>
                    </v-card>
                </v-col>
            ...
            <v-row>
                ...
                <v-col cols="12" sm="3" class="mt-n6 px-0">
                    <v-toolbar flat outlined>
                        <v-toolbar-title> SPORT BY: <span>Price $-$$</span>
                        </v-toolbar-title>
                        <v-spacer></v-spacer>
                    ...
                    <v-card flat outlined tile>
                        ...
                        <v-list dense class="mt-n5">
                            <v-list-item v-for="style in styles" :key="style.title">
                                <v-list-item-content>
                                    <v-list-item-title :text="style.title" class="ml-8"></v-list-item-title>
                                </v-list-item-content>
                                <v-list-item-action>
                                    <v-list-item-subtitle :text="style.count"></v-list-item-subtitle>
                                </v-list-item-action>
                            </v-list-item>
                        </v-list>
                    </v-card>
                    ...
                    <v-card flat outlined tile>
                        ...
                        <v-list dense class="mt-n5">
                            <v-list-item v-for="brand in brands" :key="brand.title">
                                <v-list-item-content>
                                    <v-list-item-title :text="brand.title" class="ml-6"></v-list-item-title>
                                </v-list-item-content>
                                <v-list-item-action>
                            ...
                            <v-hover v-slot:default="{ hover }">
                                <v-card height="300" align="center" flat outlined tile>
                                    ...
                                    <v-card-text class="mt-n4">
                                        <strong :class="hover ? 'red--text' : 'black--text'">{{ clothe.title
                                        }}</strong>
                                    </v-card-text>
                                    <v-expand-transition>
                              ...
                              " style="height: 100%">
                                            <v-btn rounded color="white">
                                                <v-icon>mdi-cart-outlined</v-icon> Buy </v-btn>
        ...
        <v-card color="#EFF0F2" height="250px" tile flat dark class="d-flex align-center justify-center mt-n10 card2">
            <v-row>
                ...
                <v-col cols="12" sm="12">
                    <h6 class="text-center grey--text"> Lorem ipsum dolor sit amet consectetur adipisicing elit. Adipisci
                        dolorem dignissimos <br /> Eos eligendi cupiditate cumque nemo sapiente quae omnis doloribus
                        ducimus. </h6>
                </v-col>
                <v-col cols="12" sm="12">
